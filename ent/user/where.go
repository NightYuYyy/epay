...
func FeeRate(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldFeeRate, v))
}
...
func FeeRateEQ(v float64) predicate.User {
	return predicate.User(sql.FieldEQ(FieldFeeRate, v))
}

// FeeRateNEQ applies the NEQ predicate on the "fee_rate" field.
func FeeRateNEQ(v float64) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldFeeRate, v))
}

// FeeRateIn applies the In predicate on the "fee_rate" field.
func FeeRateIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldIn(FieldFeeRate, vs...))
}

// FeeRateNotIn applies the NotIn predicate on the "fee_rate" field.
func FeeRateNotIn(vs ...float64) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldFeeRate, vs...))
}

// FeeRateGT applies the GT predicate on the "fee_rate" field.
func FeeRateGT(v float64) predicate.User {
	return predicate.User(sql.FieldGT(FieldFeeRate, v))
}

// FeeRateGTE applies the GTE predicate on the "fee_rate" field.
func FeeRateGTE(v float64) predicate.User {
	return predicate.User(sql.FieldGTE(FieldFeeRate, v))
}

// FeeRateLT applies the LT predicate on the "fee_rate" field.
func FeeRateLT(v float64) predicate.User {
	return predicate.User(sql.FieldLT(FieldFeeRate, v))
}

// FeeRateLTE applies the LTE predicate on the "fee_rate" field.
func FeeRateLTE(v float64) predicate.User {
	return predicate.User(sql.FieldLTE(FieldFeeRate, v))
}
...
func HasSettlements() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSettlementsWith(preds ...predicate.Settlement) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasWithdraws() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWithdrawsWith(preds ...predicate.Withdraw) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasRefunds() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRefundsWith(preds ...predicate.Refund) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newRefundsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
