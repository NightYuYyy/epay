...
func (_q *UserQuery) QueryProducts() *ProductQuery {
...
func (_q *UserQuery) QuerySettlements() *SettlementQuery {
...
func (_q *UserQuery) QueryWithdraws() *WithdrawQuery {
...
func (_q *UserQuery) QueryRefunds() *RefundQuery {
...
func (_q *UserQuery) WithProducts(opts ...func(*ProductQuery)) *UserQuery {
	query := (&ProductClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithSettlements(opts ...func(*SettlementQuery)) *UserQuery {
	query := (&SettlementClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithWithdraws(opts ...func(*WithdrawQuery)) *UserQuery {
	query := (&WithdrawClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) WithRefunds(opts ...func(*RefundQuery)) *UserQuery {
	query := (&RefundClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withSettlements; query != nil {
		if err := _q.loadSettlements(ctx, query, nodes,
			func(n *User) { n.Edges.Settlements = []*Settlement{} },
			func(n *User, e *Settlement) { n.Edges.Settlements = append(n.Edges.Settlements, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withWithdraws; query != nil {
		if err := _q.loadWithdraws(ctx, query, nodes,
			func(n *User) { n.Edges.Withdraws = []*Withdraw{} },
			func(n *User, e *Withdraw) { n.Edges.Withdraws = append(n.Edges.Withdraws, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withRefunds; query != nil {
		if err := _q.loadRefunds(ctx, query, nodes,
			func(n *User) { n.Edges.Refunds = []*Refund{} },
			func(n *User, e *Refund) { n.Edges.Refunds = append(n.Edges.Refunds, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadProducts(ctx context.Context, query *ProductQuery, nodes []*User, init func(*User), assign func(*User, *Product)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(product.FieldUserID)
	}
...
func (_q *UserQuery) loadSettlements(ctx context.Context, query *SettlementQuery, nodes []*User, init func(*User), assign func(*User, *Settlement)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(settlement.FieldUserID)
	}
	query.Where(predicate.Settlement(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.SettlementsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadWithdraws(ctx context.Context, query *WithdrawQuery, nodes []*User, init func(*User), assign func(*User, *Withdraw)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(withdraw.FieldUserID)
	}
	query.Where(predicate.Withdraw(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.WithdrawsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadRefunds(ctx context.Context, query *RefundQuery, nodes []*User, init func(*User), assign func(*User, *Refund)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(refund.FieldUserID)
	}
	query.Where(predicate.Refund(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.RefundsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
