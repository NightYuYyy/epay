...
func (_c *UserCreate) SetFeeRate(v float64) *UserCreate {
	_c.mutation.SetFeeRate(v)
	return _c
}

// SetNillableFeeRate sets the "fee_rate" field if the given value is not nil.
func (_c *UserCreate) SetNillableFeeRate(v *float64) *UserCreate {
	if v != nil {
		_c.SetFeeRate(*v)
	}
	return _c
...
func (_c *UserCreate) AddSettlementIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddSettlementIDs(ids...)
	return _c
}

// AddSettlements adds the "settlements" edges to the Settlement entity.
func (_c *UserCreate) AddSettlements(v ...*Settlement) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddWithdrawIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddWithdrawIDs(ids...)
	return _c
}

// AddWithdraws adds the "withdraws" edges to the Withdraw entity.
func (_c *UserCreate) AddWithdraws(v ...*Withdraw) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddRefundIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddRefundIDs(ids...)
	return _c
}

// AddRefunds adds the "refunds" edges to the Refund entity.
func (_c *UserCreate) AddRefunds(v ...*Refund) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.FeeRate(); !ok {
		return &ValidationError{Name: "fee_rate", err: errors.New(`ent: missing required field "User.fee_rate"`)}
	}
	if _, ok := _c.mutation.Status(); !ok {
