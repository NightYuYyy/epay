...
func (e SettlementEdges) MerchantOrErr() (*Merchant, error) {
	if e.Merchant != nil {
...
func (*Settlement) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case settlement.FieldID, settlement.FieldMerchantID:
...
// QueryMerchant queries the "merchant" edge of the Settlement entity.
func (_m *Settlement) QueryMerchant() *MerchantQuery {
	return NewSettlementClient(_m.config).QueryMerchant(_m)
}
